...
public class FakePlayerRender {
    ...
    private void rend(int x, int y, Texture tex, Color color, SpriteBatch batch){
        batch.setColor(new Color(color.r, color.g, color.b, 1));
        batch.draw(tex, x, y, tex.getWidth(), tex.getHeight(), 0, 0, tex.getWidth(), tex.getHeight(), false, false);
    }
